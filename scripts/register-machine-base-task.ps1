...
Register-ScheduledTask -TaskName $TaskName -Action $action -Trigger $trigger -Settings $settings -Principal $principal -Description 'Supervises the existing machine-base launcher and ticket reconciler' -Force | Out-Null
